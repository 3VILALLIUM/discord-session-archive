...
Usage:
    python stage2_merge_dotmm_transcripts.py --session session_001
    # or
...
def main() -> None:
    ...
    session_dir = Path(args.session) if args.session else pick_session()
    if not session_dir.exists() or session_dir.parent != TRANSCRIPTS_ROOT:
