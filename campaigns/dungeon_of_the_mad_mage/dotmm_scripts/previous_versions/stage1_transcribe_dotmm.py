...
RAW_AUDIO_DIR = r"./campaigns/dungeon_of_the_mad_mage/raw_audio"
CHUNK_DIR = r"./campaigns/dungeon_of_the_mad_mage/chunks"
TRANSCRIPT_DIR = r"./campaigns/dungeon_of_the_mad_mage/transcripts"
LOG_FILE = "stage1_transcribe_dotmm.log"
...
def main():
    print(f"Running Dungeon of the Mad Mage transcription v{__version__}")
    start = time.time()
    ...
    print("Transcription complete. See transcripts/ and stage1_transcribe_dotmm.log.")
