...
function Show-BootstrapPlan {
    ...
    Write-Host "- create _local/config/handle_map.json if missing"
    Write-Host "- create _local/config/realname_map.json if missing"
    Write-Host ""
...
Write-Host "2. Run: python .\src\discord_session_archive.py --input `"C:\path\to\CraigExport`" --clean --json --notebooklm"
